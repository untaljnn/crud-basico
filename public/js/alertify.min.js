...
!function (a) {
    ...
    function n() {
        ...
        var d = {};
        return {
            defaults: q, dialog: function (d, e, f, g) {
    ...
    var o = ":not(:disabled):not(.ajs-reset)", p = {ENTER: 13, ESC: 27, F1: 112, F12: 123, LEFT: 37, RIGHT: 39, TAB: 9},
        q = {
            autoReset: !0,
            basic: !1,
            closable: !0,
    ...
    var u = function (a, b, c, d, e) {
        ...
        function X(a) {
            ...
            var b = r[r.length - 1], c = a.keyCode;
        ...
        var Ba, Ca, Da = [], Ea = null, Fa = !1,
            Ga = a.navigator.userAgent.indexOf("Safari") > -1 && a.navigator.userAgent.indexOf("Chrome") < 0, Ha = {
            ...
            }, Ja = "", Ka = 0, La = !1, Ma = 0, Na = 0, Oa = !1, Pa = null, Qa = 0, Ra = 0, Sa = "pageX", Ta = "pageY",
            Ua = null, Va = !1, Wa = null, Xa = null, Ya = Number.Nan, Za = 0, $a = 0, _a = 0;
        return {
            __init: n, isOpen: function () {
                ...
                var c = this, d = G(this, this.__internal.options, function (a, b, d) {
                    F(c, a, b, d)
                }, a, b);
                if ("get" === d.op) return d.found ? d.value : void 0 !== this.settings ? G(this, this.settings, this.settingUpdated || function () {
                }, a, b).value : void 0;
                if ("set" === d.op) {
        ...
        var l, m, n = [], o = q.notifier.classes, p = o.base;
        return {
            setting: function (a, b) {
            ...
            timer: null, index: null, text: null, duration: null, task: function (b, d) {
                if (d.isOpen()) {
                    if (d.__internal.buttons[c.index].element.innerHTML = c.text + " (&#8207;" + c.duration + "&#8207;) ", c.duration -= 1, -1 === c.duration) {
                        a(d);
                        var e = d.__internal.buttons[c.index], f = l(c.index, e);
